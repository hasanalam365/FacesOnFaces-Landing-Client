  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="relative w-full max-w-2xl max-h-[85vh] overflow-y-auto overscroll-contain rounded-3xl border border-cyan-400/20 bg-[#0f1519] p-8 shadow-[0_0_50px_rgba(34,211,238,.15)]"
      >
        {/* Close */}
        <button
          onClick={onClose}
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="flex items-center justify-center text-black h-14 w-14 rounded-2xl bg-cyan-400 shrink-0">
            <BookOpen size={24} />
          </div>
          ...
          <div className="grid gap-6 mb-12 md:grid-cols-3">
            <div className="p-6 border rounded-2xl border-cyan-400/20 bg-white/[0.03]">
              ...
              <div className="flex items-center gap-3 mt-3">
                <span className="text-lg line-through text-white/30">£1,599</span>
                <span className="text-3xl font-bold text-cyan-400">£1,099</span>
              </div>
            ...
            <div className="p-6 border rounded-2xl border-cyan-400/20 bg-white/[0.03]">
              ...
              <h3 className="mt-3 text-2xl font-semibold text-white">3 Days</h3>
              <p className="mt-1 text-white/60">Intensive Practical Training</p>
            </div>

            <div className="p-6 border rounded-2xl border-cyan-400/20 bg-white/[0.03]">
              <p className="text-sm text-white/50">Certifications</p>
              <h3 className="mt-3 text-2xl font-semibold text-white">14 Included</h3>
              <p className="mt-1 text-white/60">Industry recognised CPD certificates</p>
            </div>
          </div>
